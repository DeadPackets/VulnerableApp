...
/**
 * Runs all {@link ModuleSeeder} implementations during startup, ensuring the database is populated
...
public class DatabaseSeeder implements SmartInitializingSingleton {
    ...
    // Seeds during the context refresh. The web server binds its port after this, so no request
    // can reach a level whose table is still empty.
    @Override
